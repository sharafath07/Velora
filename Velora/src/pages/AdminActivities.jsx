...
const AdminActivities = () => {
  ...
  useEffect(() => {
    const fetchActivities = async () => {
      try {
        const response = await fetch(`http://localhost:5000/api/admin/activities?page=${page}&limit=20`, {
          headers: {
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-bold text-gray-900 mb-2">System Activities</h1>
            ...
            {filteredActivities.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  {searchTerm ? 'Try adjusting your search criteria.' : 'System activities will appear here.'}
                </p>
              </div>
            )}
          </div>
