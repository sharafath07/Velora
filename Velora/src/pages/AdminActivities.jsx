...
const AdminActivities = () => {
    ...
    const fetchActivities = async () => {
      try {
        const response = await fetch(
          `http://localhost:5000/api/admin/activities?page=${page}&limit=20`,
          {
            headers: {
  ...
  const getActionBadgeColor = (action) => {
    const colors = {
      ...
      admin_view_analytics: 'bg-purple-100 text-purple-800',
      admin_view_activities: 'bg-purple-100 text-purple-800',
    };
