...
const Activities = () => {
  ...
  // ✅ Create an axios instance with baseURL and token
  ...
  useEffect(() => {
    ...
    if (state?.token) fetchActivities();
  }, [state.token, page]);
  ...
  const getActivityIcon = (action) => {
    const icons = {
      ...
      profile_update: <Activity className="h-4 w-4 text-blue-500" />,
      password_change: <Activity className="h-4 w-4 text-orange-500" />,
    };
